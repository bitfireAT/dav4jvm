...
class XmlReader(
    ...
    /**
     * Processes all the tags named [tagName], and sends every tag that has the [at.bitfire.dav4jvm.ktor.property.caldav.SupportedCalendarData.Companion.CONTENT_TYPE]
     * attribute with [onNewType].
     *
     * @param tagName The name of the tag that contains the [at.bitfire.dav4jvm.ktor.property.caldav.SupportedCalendarData.Companion.CONTENT_TYPE] attribute value.
